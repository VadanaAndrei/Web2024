        ...
        <div class="container_stats">
            <div class="text-box">
                ...
                <p>Users can report observations of stray animals directly through our user-friendly interface. These
                    ...
                    online access and in CSV format for data analysis and record-keeping. This flexibility in presenting
                    data allows users to extract information in the most efficient way for their needs. This flexibility
                    in presenting data allows users to extract information in
            ...
            <section id="statistics">
                ...
                <br>
                <form id="filter-form" method="POST" action="Stats/generateStats">
                    ...
                    <div class="form-group">
                        ...
                        <select id="animal-select" name="animal" required>
                    ...
                    <button type="submit" name="generate" value="csv">Generate CSV</button>
                    <button type="submit" name="generate" value="html">Generate HTML</button>
                </form>
