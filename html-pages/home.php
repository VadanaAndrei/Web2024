    ...
    <div class="container-index">
      <div class="top-section">
        <div class="report">
          ...
          <button type="button" class="report__button" onclick="window.location.href='../html-pages/report.php';">Report</button>
        ...
        <div class="stats">
          ...
          <button type="button" class="stats__button" onclick="window.location.href='../html-pages/stats.php';">Statistics</button>
      ...
      <div class="bottom-section">
        <div class="rss_feed">
          ...
          <br>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur harum natus porro aliquid magni
            voluptatum
            reiciendis, inventore explicabo voluptate tempore laudantium neque tempora eum quo ipsum dolores itaque
            ducimus
            odio? Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores sint ratione saepe aspernatur
            ipsam
            rem
            exercitationem esse delectus iusto alias ab nulla eveniet quos perferendis magni repudiandae, explicabo
            veniam
            dolore. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto, laborum placeat assumenda tempore
            iste
            doloribus nostrum eveniet laudantium fugiat recusandae veritatis nisi? Earum voluptate a et delectus vel
            unde
            mollitia. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil fugit ab assumenda nam ipsam
            fugiat
            accusantium, possimus adipisci aperiam tempore? Distinctio consequuntur quam dolor? Animi incidunt
            voluptatibus
            aliquam doloribus exercitationem!</p>
        </div>
